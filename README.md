...
**Please also check out CAAT, which uses the output `.bam` and `.bed` files generated by CAPPS for differential peak analysis in R. CAAT is written in shiny dashboard.**
